      ...
      <Card>
        <CardHeader className="space-y-0 pb-2">
          <div className="flex flex-col items-center">
            ...
            <CardTitle className="text-xl mb-0">Panel de Jefe de Departamento - {hospitalName}</CardTitle>
        ...
        <CardContent>
          <Alert className="mb-4 bg-blue-50 border-blue-200">
            ...
            <AlertDescription className="text-blue-700">
              Como Jefe de Departamento, puede programar cirugías seleccionando cirujanos y neurofisiólogos disponibles.
            </AlertDescription>
          </Alert>
